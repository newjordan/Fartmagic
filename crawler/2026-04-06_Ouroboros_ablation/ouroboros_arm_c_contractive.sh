...
# ONE CHANGE: SCORE contractive step on crawler loops
export CRAWLER_CONTRACTIVE_DT=0.5
export RUN_ID="ouroboros_arm_c_contractive_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/Ouroboros_ablation/scripts/train_gpt_arm_c_contractive.py" | head -1)"

...
if [[ ${FAIL} -eq 0 ]]; then
    ...
    echo "    git checkout -b submission/<name> upstream/main"
    echo "    git checkout TEST_LAB -- records/track_10min_16mb/YYYY-MM-DD_<Name>_8xH100/"
    echo "    git add records/track_10min_16mb/YYYY-MM-DD_<Name>_8xH100/"

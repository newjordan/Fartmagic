...
class Hyperparameters:
    ...
    # Mixed-bit quantization: per-category bit widths (Rascal II port)
...
class CrawlerGPT(nn.Module):
    ...
    def _run_crawler(self, x: Tensor, x0: Tensor, input_ids: Tensor, ve_cache: dict,
        ...
        for loop in range(self.crawler_loops):
            ...
            # Provides stability for deep recurrence via contraction mapping.
...
def main() -> None:
    ...
    bit_policy = build_quant_policy(args)

...
export QUANT_ARTIFACT_PATH="final_model.arm_e_ddl.ptz"
export RUN_ID="ablation_arm_e_ddl_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/Rascal_II_mixed_int_lab/train_gpt_arm_e_ddl.py" | head -1)"

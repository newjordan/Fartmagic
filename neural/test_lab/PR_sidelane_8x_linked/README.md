...
- Longworm submission-safe launcher (default arm: `35_v1_5_longworm_context_mech_l11_d528_h12_kv4_non_ngram_brotli`, no forced 4K metric): `run_longworm_submission.sh`

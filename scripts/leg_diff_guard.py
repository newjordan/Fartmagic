#!/usr/bin/env python3
"""Guard experiment leg edits against overly broad train_gpt.py changes.

Usage:
  python3 scripts/leg_diff_guard.py legs/2026-04-11_Midnight_Magnum
  python3 scripts/leg_diff_guard.py legs/2026-04-11_Midnight_Magnum --write-lock
  python3 scripts/leg_diff_guard.py legs/2026-04-11_Midnight_Magnum --check-lock
  python3 scripts/leg_diff_guard.py path/to/train_gpt.py --parent vault/train_gpt_midnight_iii_base.py
"""

...
set -euo pipefail
# ================================================================
# Trapper Keeper 1 — 8F+3C production gate
#
# Based on BWX 9F with two changes:
#   NUM_FLAT_LAYERS: 9 -> 8
#   NUM_CRAWLER_LAYERS: 1 -> 3
#
# Usage:
#   SEED=444 NPROC_PER_NODE=8 bash crawler/2026-04-09_Trapper_Keeper_1/run.sh
#   SEED=300 NPROC_PER_NODE=8 bash crawler/2026-04-09_Trapper_Keeper_1/run.sh
# ================================================================
...
echo ""
echo "============================================"
echo "  RESULT — Trapper Keeper 1 (8F+3C) seed=${SEED}"

# Agent Brief — 2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off

## Scope
You may edit only files listed in:
`legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off/agent_allowlist.txt`
...
6. Run `python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off` before any gate, full run, or commit.
...
## Commands
```bash
bash scripts/agent_guard.sh snapshot pre_midnight_iii_v_2_7_online_gptq_compile_off
python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off
bash legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off/gate.sh
bash legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off/run.sh
bash scripts/agent_guard.sh check legs/2026-04-14_midnight_iii_v_2_7_online_gptq_compile_off/agent_allowlist.txt --delta-latest
```

...
set -euo pipefail
# ================================================================
# BW XII — Helix SplitHead Production Run
#
# Full cross-attention crawler + fat bridge + high WD + loop-aware GPTQ
#
# Usage:
#   SEED=444 NPROC_PER_NODE=8 bash crawler/2026-04-04_BWXII_Helix_SplitHead/run.sh
#   SEED=300 NPROC_PER_NODE=8 bash crawler/2026-04-04_BWXII_Helix_SplitHead/run.sh
# ================================================================
...
echo ""
echo "============================================"
echo "  BW XII — Helix SplitHead"
echo "  seed=${SEED} GPUs=${NPROC} wallclock=600s"
echo "  CRAWLER_CROSS_HEADS=4 HELIX_DIM=192"
echo "  MUON_WD=0.12 LOOP_AWARE_GPTQ=1"
echo "  log: ${LOG_TS}"
echo "============================================"
echo ""

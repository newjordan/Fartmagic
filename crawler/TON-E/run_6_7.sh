...
# 6F+3C variant — one fewer flat layer than the 7F+3C SOTA.
# Everything else identical to run_nightcrawler_cubed_8k_sink_fused.sh.
export SEED="${SEED:-4}"
export RUN_ID="${RUN_ID:-tone_6_7_v8k_sink_fused_s${SEED}}"

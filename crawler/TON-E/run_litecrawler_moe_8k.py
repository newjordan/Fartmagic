...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Canonical 8k litecrawler+MoE launcher.")
...
def build_config(args: argparse.Namespace) -> RunConfig:
    ...
    run_id = args.run_id or f"litecrawler_moe_8k_s{args.seed}"
    return RunConfig(
        seed=args.seed,

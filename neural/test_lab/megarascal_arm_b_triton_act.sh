...
# Megarascal Arm B — Triton LeakyReLU² kernel (existing, just not default)
export SEED="${SEED:-300}"
export NPROC_PER_NODE="${NPROC_PER_NODE:-4}"
export ITERATIONS=2000
export MAX_WALLCLOCK_SECONDS=9999
export MLP_KERNEL_MODE="triton_act"
export RUN_ID="megarascal_arm_b_triton_act_seed${SEED}"

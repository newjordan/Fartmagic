...
- Verdict: CONFIRMED
## Notes
- Parent leg pathology to fix:
  - `gptq:calibrated 0 layers`
  - `final_quant_roundtrip_exact` far worse than post-EMA quality
  - `final_sliding_window_exact` logged on the live model rather than the reloaded quantized artifact

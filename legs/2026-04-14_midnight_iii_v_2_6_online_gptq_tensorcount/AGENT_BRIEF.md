# Agent Brief — 2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount

## Scope
You may edit only files listed in:
`legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount/agent_allowlist.txt`
...
6. Run `python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount` before any gate, full run, or commit.
...
## Commands
```bash
bash scripts/agent_guard.sh snapshot pre_midnight_iii_v_2_6_online_gptq_tensorcount
python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount
bash legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount/gate.sh
bash legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount/run.sh
bash scripts/agent_guard.sh check legs/2026-04-14_midnight_iii_v_2_6_online_gptq_tensorcount/agent_allowlist.txt --delta-latest
```

...
class Hyperparameters:
    ...
    quant_embed_bits = 8
    quant_other_bits = 8
    quant_artifact_path = "final_model.mixed.ptz"
    init_model_path = ""
    ...
    ngram_eval_buckets = 1000000
    ngram_eval_max_seconds = 60.0
    skip_final_eval = False
    loader_mode = "coprime"
    coprime_max_loaded_shards = 12
    coprime_shards_per_batch = 8
    coprime_shard_hold_steps = 1
    complement_alpha = 0.0
    ttt_enabled = True
    ttt_lr = 0.005
    ttt_epochs = 3
    ttt_momentum = 0.9
    ttt_chunk_tokens = 32768
    # Added rank and world_size for initialization

...
# Midnight Anchor export profile:
# - stay shape-identical to the producing modelbuild leg
# - export-only: load a finished checkpoint and run compression/eval only
...
export INIT_MODEL_PATH=/workspace/SOTA_FINAL/artifacts/midnight_anchor/final_model_anchor.pt
export ITERATIONS=0

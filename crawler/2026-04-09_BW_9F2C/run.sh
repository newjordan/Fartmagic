...
set -euo pipefail
# ================================================================
# BW_9F2C — production full run
# Only diff from BWX 9F parent: NUM_CRAWLER_LAYERS=2
#
# Usage:
#   SEED=444 NPROC_PER_NODE=8 bash crawler/2026-04-09_BW_9F2C/run.sh
#   SEED=300 NPROC_PER_NODE=8 bash crawler/2026-04-09_BW_9F2C/run.sh
# ================================================================
...
NUM_CRAWLER_LAYERS="${NUM_CRAWLER_LAYERS:-2}"
CRAWLER_LOOPS="${CRAWLER_LOOPS:-3}"
CRAWLER_QUANT_INT8="${CRAWLER_QUANT_INT8:-0}"

...
echo ""
echo "Diff guard:"
echo "  python3 scripts/leg_diff_guard.py \"${LEG_DIR}\""
echo "Lock after review:"
echo "  python3 scripts/leg_diff_guard.py \"${LEG_DIR}\" --write-lock"
echo "Verify before pod fire:"
echo "  python3 scripts/leg_diff_guard.py \"${LEG_DIR}\" --check-lock"
echo ""

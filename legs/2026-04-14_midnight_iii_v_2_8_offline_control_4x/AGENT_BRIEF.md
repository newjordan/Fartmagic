# Agent Brief — 2026-04-14_midnight_iii_v_2_8_offline_control_4x

## Scope
You may edit only files listed in:
`legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/agent_allowlist.txt`
...
6. Run `python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x` before any gate, full run, or commit.
...
## Commands
```bash
bash scripts/agent_guard.sh snapshot pre_midnight_iii_v_2_8_offline_control_4x
python3 scripts/leg_diff_guard.py legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x
bash legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/gate.sh
bash legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/run.sh
bash scripts/agent_guard.sh check legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/agent_allowlist.txt --delta-latest
```

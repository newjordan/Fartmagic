...
TRAIN_SCRIPT="${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/train_gpt.py"
TRACKED_ENV="${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/tracked_env.sh"
LOG_DIR="${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/logs"
mkdir -p "${LOG_DIR}"
...
# LEG_DIFF_GUARD_ARGS="--max-code-changes 80 --max-total-changed-lines 120" bash ${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x/run.sh
if [[ -n "${LEG_DIFF_GUARD_ARGS:-}" ]]; then
  # shellcheck disable=SC2086
  python3 "${REPO_ROOT}/scripts/leg_diff_guard.py" "${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x" ${LEG_DIFF_GUARD_ARGS}
else
  python3 "${REPO_ROOT}/scripts/leg_diff_guard.py" "${REPO_ROOT}/legs/2026-04-14_midnight_iii_v_2_8_offline_control_4x"
fi

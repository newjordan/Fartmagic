...
# Ouroboros baseline — exact config from PR #1308
...
export RUN_ID="ouroboros_control_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/ouroboros_ablation/train_gpt.py" | head -1)"

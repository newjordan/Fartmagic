...
LEG_DIR="${REPO_ROOT}/legs/2026-04-15_midnight_anchor_compress_loop_restore"
...
reject_adhoc_env() {
  local vars=(
    ...
    NUM_LOOPS INIT_MODEL_PATH WARMUP_STEPS
...
# LEG_DIFF_GUARD_ARGS="--max-code-changes 320 --max-total-changed-lines 430" bash ${LEG_DIR}/gate.sh
DEFAULT_LEG_DIFF_GUARD_ARGS="--max-code-changes 320 --max-total-changed-lines 430"

...
set -euo pipefail
# ================================================================
#  Bandit_Wagon_V_PyramidCannon — 1GPU PROXY GATE
#
...
#
#  NOTE: This is a 2-variable test. Run ONLY after:
#    - Bandit_Wagon_V_Cannon gate_8gpu confirms speed holds
...
echo "================================================================"
echo "  BWV PYRAMID+CANNON — 1GPU PROXY"
echo "  ${ABLATION_STEPS} steps | seed=${SEED}"
echo "  Hypothesis: pyramid gives cannon calibration target"
...
run_arm() {
    ...
    echo ""
    echo "--- ${arm_id}: ${label} ---"
    local logfile="${LOGDIR}/bwvpc_${arm_id}_s${SEED}_$(date +%H%M%S).log"
...
echo ""
echo "================================================================"
echo "  BWV PYRAMID+CANNON 1GPU SUMMARY"

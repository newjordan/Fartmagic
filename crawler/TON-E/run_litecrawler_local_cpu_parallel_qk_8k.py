...
class RunConfig:
    ...
    def env(self) -> dict[str, str]:
        return {
            ...
            "LITE_CRAWLER_QK_GAIN_INIT": "5.25",
            "LITE_CRAWLER_PARALLEL_RESIDUAL": "1",
    ...
    def summary(self) -> str:
        return "\n".join(
            [
                ...
                "  slots: 64 x 128",
                "  lessons: parallel residual + qk gain 5.25",
                "  cpu_cold_pages: 16",
                "  moe: off",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Canonical 8k local-trunk litecrawler with CPU cold memory, slot parallel residuals, and QK gain.")
...
def build_config(args: argparse.Namespace) -> RunConfig:
    ...
    run_id = args.run_id or f"litecrawler_local_cpu_parallel_qk_8k_s{args.seed}"
    return RunConfig(
        seed=args.seed,

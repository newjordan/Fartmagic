...
6. Run \`python3 scripts/leg_diff_guard.py ${LEG_DIR}\` before any gate, full run, or commit.
...
echo "  6) New test condition? Create a new leg instead of mutating this one."

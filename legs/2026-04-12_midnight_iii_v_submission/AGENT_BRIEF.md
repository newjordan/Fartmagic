# Agent Brief — 2026-04-12_midnight_iii_v_submission

## Scope
You may edit only files listed in:
`legs/2026-04-12_midnight_iii_v_submission/agent_allowlist.txt`
...
6. Run `python3 scripts/leg_diff_guard.py legs/2026-04-12_midnight_iii_v_submission` before any gate, full run, or commit.
...
## Commands
```bash
bash scripts/agent_guard.sh snapshot pre_midnight_iii_v_submission
python3 scripts/leg_diff_guard.py legs/2026-04-12_midnight_iii_v_submission
bash legs/2026-04-12_midnight_iii_v_submission/gate.sh
bash legs/2026-04-12_midnight_iii_v_submission/run.sh
bash scripts/agent_guard.sh check legs/2026-04-12_midnight_iii_v_submission/agent_allowlist.txt --delta-latest
```

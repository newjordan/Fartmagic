# Agent Brief — 2026-04-13_midnight_iii_v_qattn6

## Scope
You may edit only files listed in:
`legs/2026-04-13_midnight_iii_v_qattn6/agent_allowlist.txt`
...
6. Run `python3 scripts/leg_diff_guard.py legs/2026-04-13_midnight_iii_v_qattn6` before any gate, full run, or commit.
...
python3 scripts/leg_diff_guard.py legs/2026-04-13_midnight_iii_v_qattn6
bash legs/2026-04-13_midnight_iii_v_qattn6/gate.sh
bash legs/2026-04-13_midnight_iii_v_qattn6/run.sh
bash scripts/agent_guard.sh check legs/2026-04-13_midnight_iii_v_qattn6/agent_allowlist.txt --delta-latest
```

...
class RunConfig:
    ...
    def env(self) -> dict[str, str]:
        return {
            ...
            # Force plain flat GPT, 8 layers, 8k vocab.
            "TON_E_RHYTHM": "0",
            "USE_CRAWLER": "0",
            "VOCAB_SIZE": "8192",
            "NUM_LAYERS": "8",
            ...
            "NUM_HEADS": "8",
            "NUM_KV_HEADS": "4",
            # Match the plain Nightcrawler-style baseline settings where applicable.
            "TIE_EMBEDDINGS": "1",
            "MLP_ACT": "relu_sq",
            "MLP_LEAKY_SLOPE": "0.5",
            "ROPE_DIMS": "16",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Canonical 8F flat 8k launcher."
    )
...
def build_config(args: argparse.Namespace) -> RunConfig:
    ...
    run_id = args.run_id or f"flat_8f_8k_s{args.seed}"
    return RunConfig(
        seed=args.seed,

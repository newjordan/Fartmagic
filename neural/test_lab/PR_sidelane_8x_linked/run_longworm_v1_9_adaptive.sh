...
RUNNER="${SCRIPT_DIR}/sidelane/scripts/run_v1_9_longworm_adaptive_ablation.sh"
...
export PROJECT_CODENAME="${PROJECT_CODENAME:-longworm_v1_9}"
export SUBMISSION_PROFILE="${SUBMISSION_PROFILE:-track_10min_16mb}"
export NPROC_PER_NODE="${NPROC_PER_NODE:-1}"
export ARM_ONLY="${ARM_ONLY:-}"
...
echo "============================================================"
echo "Longworm v1.9 adaptive ablation launcher"
echo "train_py: ${TRAIN_PY}"
echo "arm_only: ${ARM_ONLY:-<all>}"

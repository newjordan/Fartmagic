...
# ONE CHANGE: Noisy QAT on crawler blocks
export NOISY_QAT=1
export RUN_ID="ouroboros_arm_a_noisy_qat_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/Ouroboros_ablation/scripts/train_gpt_arm_a_noisy_qat.py" | head -1)"

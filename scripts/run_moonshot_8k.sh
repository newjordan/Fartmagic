...
# RWKV Moonshot 8k: linear recurrence crawler, NO ramp (crawler active from step 0).
# 7F+3C with 3 loops — crawler attention is RWKV-style linear recurrence.
...
export SEED="${SEED:-4}"
export RUN_ID="${RUN_ID:-tone_moonshot_v8k_s${SEED}}"

...
export QUANT_ARTIFACT_PATH="final_model.arm_d_heq.ptz"
export RUN_ID="ablation_arm_d_heq_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/Rascal_II_mixed_int_lab/train_gpt_arm_d_heq.py" | head -1)"

...
export QUANT_ARTIFACT_PATH="final_model.arm_a_trigram.ptz"
export RUN_ID="ablation_arm_a_trigram_seed${SEED}"

TRAIN_SCRIPT="$(find "${REPO_ROOT}" -path "*/Rascal_II_mixed_int_lab/train_gpt.py" -not -path "*arm_*" | head -1)"
